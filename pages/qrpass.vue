    ...
    <div class="content">
      ...
      <div v-if="status">
        ...
        <div class="none">
          ...
          <h4>
            ミッションマップを
            <n-link to="/map">こちら</n-link>から印刷できます。
          </h4>
        </div>
      </div>
      <br />
      <div class="none">
        <h3>QR-PASSを発行すると特典があります</h3>
        <p>
          QR-PASSで受付された方にランダムでMD高岡オリジナルの缶バッチが当たります！
          <br />どれが当たるかはお楽しみ♪
        </p>
        <img src="~/assets/img/qr-pass.jpg" />
        <h3>QR-PASSとは?🤔</h3>
        <p>
        ...
        <p>
          また、QR-PASSはメダルを確実にお届けするため、万が一データを失ったときも、回収させていただいた紙からの復元を可能にします。
          <br />詳しくはヘルプをご覧ください。
        </p>
        <p>
          iPhoneでエージェント名がうまく入力できない現象を確認しております。
          <br />メモ帳などに一度入力し、コピーして入力欄に貼り付けていただくか、🌐(地球マーク)をタップし英語モードに切り替えていただくようお願いします。
        </p>
      </div>
    </div>
  </no-ssr>
